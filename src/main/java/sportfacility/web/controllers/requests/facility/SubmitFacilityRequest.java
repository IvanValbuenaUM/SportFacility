...
public class SubmitFacilityRequest {
	...
	private List<SubmitTimetableRequest> reservations = new ArrayList<>();
	
	public SubmitFacilityRequest() {
		super();
	}
	
	public SubmitFacilityRequest(String facilityCode, int maxCapacity, int pricePerHour,
	...
	public void addReservation(SubmitTimetableRequest t)
	{
		if (t == null)
	...
	public boolean removeReservation(SubmitTimetableRequest t)
	{
		if (t == null)
	...
	public List<SubmitTimetableRequest> getReservations() {
		return reservations;
	}
}
