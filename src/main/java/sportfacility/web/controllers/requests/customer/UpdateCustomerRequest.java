...
public class UpdateCustomerRequest {
	...
	private List<UpdateTimetableRequest> reservations = new ArrayList<>();
	...
	public UpdateCustomerRequest(String name, String surname, int age, String id, int membershipNumber) 
	{
		super();
		this.setName(name);
	...
	public void addReservation(UpdateTimetableRequest t)
	{
		if (t == null)
	...
	public boolean removeReservation(UpdateTimetableRequest t)
	{
		if (t == null)
	...
	public List<UpdateTimetableRequest> getReservations() {
		return reservations;
	}
}
