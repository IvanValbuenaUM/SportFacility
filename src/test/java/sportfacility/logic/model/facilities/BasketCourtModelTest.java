...
class BasketCourtModelTest {
    ...
    void constructorTest()
    {
        ...
        new BasketCourtModel("AB12", 10, 50, closedDays, 3, 20, 13, 0);
    }
    ...
    void nBasketBallsMoreTest()
    {
        ...
        IllegalArgumentException thrown = assertThrows(
                ...
                () -> new BasketCourtModel("AB12", 10, 50, closedDays, 3, 20, 13, -1)
        );
    ...
    void nBasketBallsLessTest()
    {
        ...
        IllegalArgumentException thrown = assertThrows(
                IllegalArgumentException.class,
                () -> new BasketCourtModel("AB12", 10, 50, closedDays, 3, 20, 13, 2)
        );
    ...
    void getNBasketBallsRentedTest()
    {
        ...
        BasketCourtModel bc = new BasketCourtModel("AB12", 10, 50, closedDays, 3, 20, 13, 1);
